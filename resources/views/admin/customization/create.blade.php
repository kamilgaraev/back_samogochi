...
@section('title', 'Создать элемент кастомизации')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Создать элемент кастомизации</h1>
            <p class="text-gray-600 mt-1">Добавление нового элемента гардероба или мебели</p>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg border">
        <form method="POST" action="{{ route('admin.customization.store') }}" class="p-6 space-y-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Описание элемента...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="wardrobe_shirt"
                               required>
                        <p class="text-sm text-gray-500 mt-1">Уникальный идентификатор группы (например: wardrobe_shirt, furniture_table)</p>
                        @error('category_key')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Создать элемент
                </button>
            </div>
        </form>
    </div>
