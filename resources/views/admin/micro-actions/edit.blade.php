                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="position" 
                            ...
                            <option value="phone" {{ old('position', $microAction->position) === 'phone' ? 'selected' : '' }}>📱 Phone (Телефон)</option>
                            <option value="tablet" {{ old('position', $microAction->position) === 'tablet' ? 'selected' : '' }}>📊 Tablet (Планшет)</option>
                            <option value="desktop" {{ old('position', $microAction->position) === 'desktop' ? 'selected' : '' }}>💻 Desktop (Компьютер)</option>
                        </select>
